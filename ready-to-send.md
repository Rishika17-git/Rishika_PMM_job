# Ready-to-send messages — top 3 leads (personalized, just add contact name/link)

Best stage/level fits from the tracker: her real experience is 2+ years solo PMM on B2B SaaS/PLG, which matches "2+ yrs SaaS" associate-level requirements directly. Send these first.

## 1. Chainalysis — Product Marketing Associate (best fit: role explicitly wants 2+ yrs SaaS/Fintech/Security)
Apply directly + LinkedIn note to the hiring manager once you find them on the team page.
